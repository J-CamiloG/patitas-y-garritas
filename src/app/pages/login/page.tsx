...
export default function Login() {
    ...
    const handleConfirmUser = (e: React.MouseEvent<HTMLButtonElement>) => {
        e.preventDefault();
        
        for (const key in dataBase) {
            if (username === dataBase[key].username && password === dataBase[key].password) {
                router.push('/pages/adminapp');
            }else{
                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        id="email" 
                                        value={username} 
                                        onChange={(e) => setUsername(e.target.value)} // Actualizar el estado de username cuando el usuario escriba
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        id="password" 
                                        value={password} 
                                        onChange={(e) => setPassword(e.target.value)} // Actualizar el estado de password cuando el usuario escriba
                                        placeholder="••••••••" 
                                        className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                        required 
                                    />
